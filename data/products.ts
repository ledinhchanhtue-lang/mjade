...
export const products: Product[] = [
  {
    ...
    imageAlt: "Mặt dây chuyền đá xanh lục bọc bạc trên nền đá màu kem",
  ...
  },
  {
    ...
    name: "Nhẫn ngọc phỉ thúy bọc vàng trắng",
    ...
    certificateVerificationUrl: null,
    shortDescription:
      "Nhẫn ngọc phỉ thúy sắc xanh đậm, bọc vàng trắng 18K theo phom cổ điển.",
    story:
      "Sắc xanh đậm trầm tĩnh của viên ngọc gợi sự vững vàng — món trang sức được nhiều khách hàng chọn làm quà tự thưởng cho một cột mốc sự nghiệp. Phần bọc vàng trắng được chế tác ôm sát để bảo vệ viền ngọc.",
    careInstructions: defaultCare,
    shippingNotes: defaultShipping,
    seoTitle: "Nhẫn Ngọc phỉ thúy bọc vàng trắng 18K | MJADE",
    seoDescription:
      "Nhẫn ngọc phỉ thúy Myanmar Type A bọc vàng trắng 18K. Chỉ còn một chiếc. Tư vấn riêng và giao hàng quốc tế.",
  },
  {
    id: "p-003",
  ...
  },
  {
    ...
    imageAlt: "Lắc tay hạt đá xanh lục điểm charm bạc trên nền gỗ trắng",
    imageIsTemporary: true,
    jadeType: "Jadeite Type A",
    origin: "Myanmar",
    color: "xanh-luc",
  ...
  },
  {
    ...
    imageAlt: "Mặt dây chuyền đá xanh lục đính đá trắng trên nền xanh rêu",
    imageIsTemporary: true,
    jadeType: "Jadeite Type A",
    origin: "Myanmar",
    color: "xanh-dam",
  ...
  },
  {
    ...
    imageAlt: "Cận cảnh nhẫn đính cụm đá xanh lục trên nền ánh vàng ngà",
    imageIsTemporary: true,
    jadeType: "Jadeite Type A",
    origin: "Myanmar",
    color: "xanh-luc",
  ...
  },
  {
    ...
    imageAlt: "Các vòng bản ngọc phỉ thúy xanh đậm trên nền vải trắng ngà",
    imageIsTemporary: true,
    jadeType: "Jadeite Type A",
    origin: "Myanmar",
    color: "xanh-dam",
