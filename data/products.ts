...
export const products: Product[] = [
  ...
  },
  {
    ...
    limited: false,
    featured: true,
    images: ["/images/products/hoa-tai-ngoc-phi-thuy-vang-18k-2.webp"],
    thumbnail: "/images/home/featured-earrings-2.webp",
    imageAlt: "Hoa tai ngọc phỉ thúy dáng giọt sắc xanh lục đeo trên tai (ảnh minh họa)",
